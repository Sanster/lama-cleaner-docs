...
This model will use the mouse click position and image as input and output a segmented mask.
Users can choose the next click position(positive or negative) based on the output. It's fun and might be useful in many scenarios.
